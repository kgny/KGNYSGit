<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TargetData.aspx.cs" Inherits="QCA.TargetData" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一指标在不同单位变化趋势分析"
                            ...
                            <tr>
                                <td>
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="center" class="style8">
                                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="指标类型:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style9">
                                            ...
                                            <td align="center" class="style12">
                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="指标名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style13">
                                                <dx:ASPxComboBox ID="ASPxComboBox_Name" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                    CssPostfix="Office2010Blue" Height="21px" Spacing="0" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css"
