<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OriginalFuel3.aspx.cs" Inherits="QCA.OriginalFuel3" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一燃料在不同工序比重分析"
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td align="center" class="style12">
                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="燃料名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style13">
                                                <dx:ASPxComboBox ID="ASPxComboBox_Fuel" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                    CssPostfix="Office2010Blue" Height="21px" Spacing="0" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css"
                                                    ValueType="System.String" Width="150px">
                                                    <LoadingPanelImage Url="~/App_Themes/Office2010Blue/Editors/Loading.gif">
                                                    </LoadingPanelImage>
