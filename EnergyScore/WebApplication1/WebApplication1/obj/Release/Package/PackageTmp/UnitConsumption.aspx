<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitConsumption.aspx.cs" Inherits="QCA.UnitConsumption" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一单耗在不同工序的变化趋势分析"
                            ...
                            <tr>
                                <td>
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="center" class="style8">
                                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="单耗类型:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style9">
                                                <dx:ASPxComboBox ID="ASPxComboBox_Type" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                    ...
                                                    SelectedIndex="0">
                                                    <Items>
                                                        <dx:ListEditItem Text="旬" Value="旬" Selected="True" />
                                                        <dx:ListEditItem Text="月" Value="月" />
                                                        <dx:ListEditItem Text="季" Value="季" />
                                                        <dx:ListEditItem Text="年" Value="年" />
                                                    </Items>
                                            ...
                                            <td align="center" class="style12">
                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="单位名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style13">
                                                <dx:ASPxComboBox ID="ASPxComboBox_Unit" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                    CssPostfix="Office2010Blue" Height="21px" Spacing="0" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css"
                             ...
                             <tr>
                                <td>
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="center" class="style8">
                                                <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="介质名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style9">
                                            ...
                                            <td align="center" class="style12">
                                                <dx:ASPxLabel ID="ASPxLabel6" runat="server" Text="产品名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style13">
                                                <dx:ASPxComboBox ID="ASPxComboBox_Product" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                    CssPostfix="Office2010Blue" Height="21px" Spacing="0" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css"
                                                    ValueType="System.String" Width="150px">
                                                    <LoadingPanelImage Url="~/App_Themes/Office2010Blue/Editors/Loading.gif">
                                                    </LoadingPanelImage>
                                            ...
                                            <td>
                                                <dx:ASPxButton ID="ASPxButton_Select" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                    CssPostfix="Office2010Blue" Height="23px" OnClick="ASPxButton_Select_Click" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css"
                            ...
                            <tr>
                                <td>
                                    <asp:chart ID="ChartColumn" runat="server" backcolor="Gainsboro" 
                                        ...
                                        borderlinedashstyle="Solid" cssclass="style1" height="281px" palette="Excel" 
                                        width="865px">
                                        <series>
