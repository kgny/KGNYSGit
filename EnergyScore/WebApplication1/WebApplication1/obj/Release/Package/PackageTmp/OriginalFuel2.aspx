<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OriginalFuel2.aspx.cs" Inherits="QCA.OriginalFuel2" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一燃料在不同单位趋势分析"
