<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OriginalFuel1.aspx.cs" Inherits="QCA.OriginalFuel1" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一燃料在不同单位比重分析"
