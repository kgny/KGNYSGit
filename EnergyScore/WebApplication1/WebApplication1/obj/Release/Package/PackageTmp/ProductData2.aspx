<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductData2.aspx.cs" Inherits="QCA.ProductData2" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一产品在不同单位趋势分析"
