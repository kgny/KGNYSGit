<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MediaDay2.aspx.cs" Inherits="QCA.MediaDay2" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一介质在同工序不同站所比重分析"
                            ...
                            <tr>
                                <td>
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="center" width="73px">
                                                <dx:ASPxLabel ID="ASPxLabel3" runat="server" Text="单位名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style21">
                                            ...
                                            <td align="center" width="73px">
                                                <dx:ASPxLabel ID="ASPxLabel5" runat="server" Text="工序名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style22">
                                                <dx:ASPxComboBox ID="ASPxComboBox_Process" runat="server" ClientIDMode="AutoID" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                    CssPostfix="Office2010Blue" Height="21px" Spacing="0" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css"
                                                    ValueType="System.String" Width="150px">
                                                    <LoadingPanelImage Url="~/App_Themes/Office2010Blue/Editors/Loading.gif">
                                                    </LoadingPanelImage>
                                            ...
                                            <td align="center" class="style24">
                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="介质名称:" Width="73px">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style23">
