                                                                ...
                                                                <table style="width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="left" width="85%">
                                                                            <dx:ASPxTextBox runat="server" Width="500px" SpriteCssFilePath="~/App_Themes/Office2010Blue/{0}/sprite.css"
                                                                                CssPostfix="Office2010Blue" CssFilePath="~/App_Themes/Office2010Blue/{0}/styles.css"
                                                                                ClientIDMode="AutoID" ID="txbDJLJ" Height="200px">
                                                                            </dx:ASPxTextBox>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="width: 25%;" align="center">
                                                                          <dx:ASPxButton 
                                                                                ...
                                                                                Text="提交" 
                                                                                Width="90px" onclick="btnConfirm_Click">
                                                                </dx:ASPxButton>
                                                                </td>
                                                                   </tr>
                                                                </table>
