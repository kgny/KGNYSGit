...
<%@ Register Assembly="DevExpress.Web.ASPxEditors.v10.2, Version=10.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxEditors" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v10.2, Version=10.2.4.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a"
    Namespace="DevExpress.Web.ASPxMenu" TagPrefix="dx1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        var zNodes = [
            { id: 1, pId: 0, name: "计划管理", isParent: true, open: true },
        ...
        //            { id: 15, pId: 1, name: "资源循环利用", tag: "ResourceRecycle.aspx" },
            {id: 2, pId: 0, name: "点检实绩管理", isParent: true, open: true },
            { id: 21, pId: 2, name: "数据接收", isParent: true, open: true },
        ...
        //            { id: 215, pId: 21, name: "同一介质在不同单位比重", tag: "MediaDay5.aspx" },
            {id: 22, pId: 2, name: "数据处理", isParent: true, open: true },
            ...
            { id: 225, pId: 22, name: "设备在线参数", tag: "DJSys/DJ_Act_Info.aspx" },

            { id: 3, pId: 0, name: "系统维护", isParent: true, open: true },
            { id: 31, pId: 3, name: "设备编码", tag: "DJSys/DJ_Act_Info.aspx" },
            { id: 32, pId: 3, name: "设备档案", tag: "DJSys/DJ_Act_Info.aspx" },
            { id: 33, pId: 3, name: "人员信息", tag: "DJSys/DJ_Act_Info.aspx" }
                                ...
                                <tr>
                                    <td valign="center">
                                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                            <tr >
                                                <td style="background-color: #CCFFFF" align="top" width="10%" height="100%">
                                                    <img src="Styles/dydj.png" style="width: 1240px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
