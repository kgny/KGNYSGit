<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductData1.aspx.cs" Inherits="QCA.ProductData1" %>
...
<body>
    ...
    <dx:ASPxRoundPanel ID="ASPxRoundPane1" runat="server" ClientIDMode="AutoID" HeaderText="同一产品在不同单位比重分析"
                                    ...
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="center" class="style12">
                                                <dx:ASPxLabel ID="ASPxLabel4" runat="server" Text="产品名称:">
                                                </dx:ASPxLabel>
                                            </td>
                                            <td class="style13">
